...
def create_brochure(filename):
    # Generous margins to allow content to breathe
...
if __name__ == '__main__':
    target_dir = '/home/farook/lixten-website/assets'
    os.makedirs(target_dir, exist_ok=True)
    pdf_path = os.path.join(target_dir, 'brochure.pdf')
    create_brochure(pdf_path)
    print(f"Editorial brochure successfully generated at: {pdf_path}")
